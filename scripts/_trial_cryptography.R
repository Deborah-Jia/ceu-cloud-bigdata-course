...
hashed.message = digest("I just heard that Yuri came back to Brazil", algo="sha256") ## algo means algorithem
...
coded = caesar("I just heard that Yuri came back to Brazil", shift=1)
...
Sys.setenv(LDFLAGS="-L/usr/local/opt/openssl@1.1/lib", # set environment variables
...
bytes.to.encode = charToRaw("Today's weather is bad!")
